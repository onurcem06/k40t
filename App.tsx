...
const ReferenceWrapper = ({ siteContent, onNavigate }: { siteContent: SiteContent, onNavigate: (v: ViewState) => void }) => {
  const { id } = useParams();
  return <ReferenceDetail view={id || ''} siteContent={siteContent} onBack={() => onNavigate('REFERENCES')} />;
};
